...
W tym artykule znajdziesz dlaczego warto i jak zacząć kontrybuować do open source, ale najpierw może powiedzmy sobie czym jest ten cały “open source”.
...
Załóżmy że znalazłeś już projekt oraz repozytorium w którym znajduje się jego kod. Ja będę pokazywał to na przykładzie Github’a.
...
<Image
  src="/images/jak-kontrybuowac-do-open-source/github-clone.webp"
  width="700"
  height="300"
  alt="asd"
/>
