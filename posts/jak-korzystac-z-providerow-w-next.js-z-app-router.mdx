...
date: '2023-05-11'
image: '/images/jak-korzystac-z-providerow-w-next.js-z-app-router/thumbnail.png'
featured: true
---
...
Do naszego specjalnego pliku o nazwie `_app.tsx` umieszczamy nasz Provider i w zasadzie tyle, od tego momentu możemy w dowolnym komponencie podrzędnym dostać się do kontektu.
