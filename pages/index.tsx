...
export const HomePage = ({
  ...
  return (
    <Layout>
      <div className="flex min-h-[60vh] animate-fade-in-up flex-col justify-center">
        ...
        <p className="max-w-2xl text-xl leading-relaxed text-gray-400 md:text-2xl">
          Witaj na moim blogu. Tworzę cyfrowe doświadczenia, piszę o
          programowaniu webowym i dzielę się wiedzą na temat nowoczesnych
          technologii.
        </p>
        ...
        <div className="mt-10 flex gap-4">
          <Link
            href="/about"
            className="inline-flex items-center rounded-full bg-white px-6 py-3 text-lg font-medium text-gray-900"
          >
            O mnie
            <svg
