...
Zaczniemy od strony frontu, gdzie stworzymy formularz, do którego będziemy wprowadzać wartości do formularza oraz pokazywać wyniki. Nie będę się skupiał teraz na wyglądzie aplikacji, ale w wersji demo będą one zawarte.
...
Na samym końcu zwracamy odpowiedź z kodem 200, oraz exporrtujemy handler.
...
jeśli chcesz sprawdzić co jeszcze potrafi zajrzyj [tuutaj](https://platform.openai.com/examples/).
